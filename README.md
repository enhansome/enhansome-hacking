...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,148 | 🐛 26 | 🌐 Python | 📅 2026-08-24
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,868 | 🐛 597 | 🌐 Ruby | 📅 2026-08-24 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,797 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,282 | 🐛 573 | 🌐 C++ | 📅 2026-08-23 - An open-source x64/x32 debugger for Windows
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,196 | 🐛 442 | 🌐 Java | 📅 2026-08-19 - a decompiler for Android apps. Not related to JAD.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 25,935 | 🐛 180 | 🌐 C# | 📅 2026-08-25 - an open-source .NET assembly browser and decompiler
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,798 | 🐛 463 | 🌐 Python | 📅 2026-08-22 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
* [USBPcap](https://github.com/desowin/usbpcap) ⭐ 1,129 | 🐛 65 | 🌐 C | 📅 2025-02-09 - USB capture for Windows.
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,532 | 🐛 3,328 | 🌐 Java | 📅 2026-08-24 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,265 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,772 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,950 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,298 | 🐛 2 | 🌐 Go | 📅 2026-08-22 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,319 | 🐛 61 | 🌐 Rust | 📅 2026-07-29 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,037 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,137 | 🐛 475 | 🌐 C | 📅 2026-08-19 - A library and collection of command-line digital forensics tools
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,579 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - Automated decryption tool using artificial intelligence & natural language processing.
