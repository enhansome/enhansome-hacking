...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,442 | 🐛 20 | 🌐 Python | 📅 2026-09-22
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 39,053 | 🐛 614 | 🌐 Ruby | 📅 2026-09-24 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,864 | 🐛 197 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,599 | 🐛 575 | 🌐 C++ | 📅 2026-09-23 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,867 | 🐛 822 | 🌐 C | 📅 2026-09-24 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 9,036 | 🐛 357 | 🌐 C | 📅 2026-09-24
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,613 | 🐛 451 | 🌐 Java | 📅 2026-09-12 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,197 | 🐛 248 | 🌐 Java | 📅 2024-07-08

* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,255 | 🐛 26 | 🌐 Rust | 📅 2026-09-24 - the best decompiler I have used. Is able to decompile apps written in Scala and Kotlin into Java code. JD-GUI and Luyten have failed to do it fully.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 26,134 | 🐛 177 | 🌐 C# | 📅 2026-09-24 - an open-source .NET assembly browser and decompiler
...
* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,997 | 🐛 446 | 🌐 JavaScript | 📅 2026-09-21
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,144 | 🐛 496 | 🌐 Python | 📅 2026-09-10 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,864 | 🐛 3,340 | 🌐 Java | 📅 2026-09-24 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,369 | 🐛 96 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,858 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,685 | 🐛 530 | 🌐 Shell | 📅 2026-09-21 - a DSL for creating parsers in a variety of programming languages. The Web IDE is particularly useful for reverse-engineering.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,033 | 🐛 415 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,500 | 🐛 6 | 🌐 Go | 📅 2026-09-24 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,451 | 🐛 55 | 🌐 Rust | 📅 2026-09-23 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,215 | 🐛 243 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,156 | 🐛 481 | 🌐 C | 📅 2026-09-17 - A library and collection of command-line digital forensics tools
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,630 | 🐛 11 | 🌐 Rust | 📅 2026-09-18 - Automated decryption tool using artificial intelligence & natural language processing.
...
* [Awesome bug bounty resources by EdOverflow](https://github.com/EdOverflow/bugbounty-cheatsheet) ⭐ 6,554 | 🐛 13 | 📅 2023-09-14
