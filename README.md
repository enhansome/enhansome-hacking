...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,276 | 🐛 32 | 🌐 Python | 📅 2026-09-02
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,956 | 🐛 611 | 🌐 Ruby | 📅 2026-09-07 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,826 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,437 | 🐛 577 | 🌐 C++ | 📅 2026-09-06 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,752 | 🐛 822 | 🌐 C | 📅 2026-09-07 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,998 | 🐛 358 | 🌐 C | 📅 2026-09-06
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,368 | 🐛 447 | 🌐 Java | 📅 2026-09-02 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,196 | 🐛 248 | 🌐 Java | 📅 2024-07-08
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 26,026 | 🐛 169 | 🌐 C# | 📅 2026-09-07 - an open-source .NET assembly browser and decompiler
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,945 | 🐛 483 | 🌐 Python | 📅 2026-09-01 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,690 | 🐛 3,366 | 🌐 Java | 📅 2026-09-07 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,319 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,823 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,989 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,395 | 🐛 18 | 🌐 Go | 📅 2026-09-02 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,382 | 🐛 61 | 🌐 Rust | 📅 2026-09-07 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,116 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,593 | 🐛 3 | 🌐 Rust | 📅 2026-09-07 - Automated decryption tool using artificial intelligence & natural language processing.
...
* [Awesome bug bounty resources by EdOverflow](https://github.com/EdOverflow/bugbounty-cheatsheet) ⭐ 6,548 | 🐛 12 | 📅 2023-09-14
