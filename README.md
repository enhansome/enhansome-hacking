...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,030 | 🐛 25 | 🌐 Python | 📅 2026-08-11
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,808 | 🐛 611 | 🌐 Ruby | 📅 2026-08-13 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,771 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
* [Hackers tools](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv) - Tutorial on tools.

### Docker Images for Penetration Testing & Security

* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,602 | 🐛 854 | 🌐 Java | 📅 2026-08-13
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,161 | 🐛 577 | 🌐 C++ | 📅 2026-08-09 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,568 | 🐛 821 | 🌐 C | 📅 2026-08-14 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,947 | 🐛 360 | 🌐 C | 📅 2026-08-13
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,059 | 🐛 443 | 🌐 Java | 📅 2026-08-05 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,173 | 🐛 248 | 🌐 Java | 📅 2024-07-08
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 25,851 | 🐛 193 | 🌐 C# | 📅 2026-08-14 - an open-source .NET assembly browser and decompiler
  * [dotPeek](https://www.jetbrains.com/decompiler/) - a free-of-charge .NET decompiler from JetBrains

* native code
  * [retdec](https://github.com/avast-tl/retdec) ⭐ 8,605 | 🐛 458 | 🌐 C++ | 📅 2026-05-26
...
* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,985 | 🐛 433 | 🌐 JavaScript | 📅 2026-08-11
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,697 | 🐛 466 | 🌐 Python | 📅 2026-08-13 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,457 | 🐛 3,317 | 🌐 Java | 📅 2026-08-14 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,228 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
...
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,200 | 🐛 9 | 🌐 Go | 📅 2026-08-12 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,280 | 🐛 60 | 🌐 Rust | 📅 2026-07-29 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 14,981 | 🐛 236 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,127 | 🐛 478 | 🌐 C | 📅 2026-08-11 - A library and collection of command-line digital forensics tools
