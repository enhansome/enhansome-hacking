...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,034 | 🐛 24 | 🌐 Python | 📅 2026-08-11
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,817 | 🐛 612 | 🌐 Ruby | 📅 2026-08-13 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,777 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
* [Hackers tools](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv) - Tutorial on tools.

### Docker Images for Penetration Testing & Security

* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,617 | 🐛 854 | 🌐 Java | 📅 2026-08-13
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,171 | 🐛 574 | 🌐 C++ | 📅 2026-08-15 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,582 | 🐛 819 | 🌐 C | 📅 2026-08-16 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,954 | 🐛 362 | 🌐 C | 📅 2026-08-13
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,086 | 🐛 443 | 🌐 Java | 📅 2026-08-05 - a decompiler for Android apps. Not related to JAD.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 25,863 | 🐛 187 | 🌐 C# | 📅 2026-08-16 - an open-source .NET assembly browser and decompiler
...
* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,986 | 🐛 434 | 🌐 JavaScript | 📅 2026-08-11
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,711 | 🐛 470 | 🌐 Python | 📅 2026-08-13 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,446 | 🐛 3,321 | 🌐 Java | 📅 2026-08-16 - a DB editor.
...
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,758 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,933 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,210 | 🐛 9 | 🌐 Go | 📅 2026-08-12 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,285 | 🐛 60 | 🌐 Rust | 📅 2026-07-29 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 14,985 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,383 | 🐛 15 | 🌐 Perl | 📅 2026-06-27 - A script to make Tor Network your default gateway.
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,129 | 🐛 479 | 🌐 C | 📅 2026-08-11 - A library and collection of command-line digital forensics tools
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,577 | 🐛 2 | 🌐 Rust | 📅 2026-08-10 - Automated decryption tool using artificial intelligence & natural language processing.
