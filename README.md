...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,241 | 🐛 30 | 🌐 Python | 📅 2026-08-27
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,933 | 🐛 604 | 🌐 Ruby | 📅 2026-09-02 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,811 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
* [Hackers tools](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv) - Tutorial on tools.

### Docker Images for Penetration Testing & Security

* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,723 | 🐛 859 | 🌐 Java | 📅 2026-09-01
* `docker pull vulnerables/web-owasp-nodegoat` - [OWASP NodeGoat](https://github.com/owasp/nodegoat#option-3---run-nodegoat-on-docker) ⭐ 2,062 | 🐛 107 | 🌐 HTML | 📅 2024-06-15
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,380 | 🐛 576 | 🌐 C++ | 📅 2026-08-30 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,715 | 🐛 822 | 🌐 C | 📅 2026-09-02 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,994 | 🐛 360 | 🌐 C | 📅 2026-09-02
* [plasma](https://github.com/joelpx/plasma) ⭐ 3,071 | 🐛 15 | 🌐 Python | 📅 2021-08-31 - Interactive disassembler for x86/ARM/MIPS. Generates indented pseudo-code with colored syntax code.
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,316 | 🐛 442 | 🌐 Java | 📅 2026-08-31 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,189 | 🐛 248 | 🌐 Java | 📅 2024-07-08

* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,248 | 🐛 25 | 🌐 Rust | 📅 2026-04-07 - the best decompiler I have used. Is able to decompile apps written in Scala and Kotlin into Java code. JD-GUI and Luyten have failed to do it fully.

* JVM-based languages

* [procyon](https://bitbucket.org/mstrobel/procyon/wiki/Java%20Decompiler)
  * [Luyten](https://github.com/deathmarine/Luyten) ⭐ 5,109 | 🐛 193 | 🌐 Java | 📅 2024-07-11 - one of the best, though a bit slow, hangs on some binaries and not very well maintained.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 25,999 | 🐛 180 | 🌐 C# | 📅 2026-09-01 - an open-source .NET assembly browser and decompiler
  * [dotPeek](https://www.jetbrains.com/decompiler/) - a free-of-charge .NET decompiler from JetBrains

* native code
  * [retdec](https://github.com/avast-tl/retdec) ⭐ 8,618 | 🐛 458 | 🌐 C++ | 📅 2026-05-26
...
* Python
  * [uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,319 | 🐛 42 | 🌐 Python | 📅 2026-04-24 - decompiler for the over 20 releases and 20 years of CPython.

### Deobfuscators

* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,994 | 🐛 439 | 🌐 JavaScript | 📅 2026-08-31
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,889 | 🐛 480 | 🌐 Python | 📅 2026-09-01 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
* [USBPcap](https://github.com/desowin/usbpcap) ⭐ 1,130 | 🐛 65 | 🌐 C | 📅 2025-02-09 - USB capture for Windows.
...
* [wxHexEditor](https://github.com/EUA/wxHexEditor) ⭐ 619 | 🐛 83 | 🌐 C | 📅 2024-06-27
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,631 | 🐛 3,361 | 🌐 Java | 📅 2026-09-02 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,301 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,805 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,669 | 🐛 529 | 🌐 Shell | 📅 2026-08-31 - a DSL for creating parsers in a variety of programming languages. The Web IDE is particularly useful for reverse-engineering.
* [Veles](https://github.com/codilime/veles) ⚠️ Archived - a visualizer for statistical properties of blobs.
* [Protobuf inspector](https://github.com/jmendeth/protobuf-inspector) ⭐ 1,126 | 🐛 5 | 🌐 Python | 📅 2020-12-13
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,967 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,362 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [VHostScan](https://github.com/codingo/VHostScan) ⭐ 1,308 | 🐛 1 | 🌐 Python | 📅 2025-08-18 - A virtual host scanner that performs reverse lookups, can be used with pivot tools, detect catch-all scenarios, aliases and dynamic default pages.
* [badtouch](https://github.com/kpcyrd/badtouch) ⭐ 419 | 🐛 24 | 🌐 Rust | 📅 2023-12-19 - Scriptable network authentication cracker
* [Keyscope](https://github.com/SpectralOps/keyscope) ⭐ 413 | 🐛 1 | 🌐 Rust | 📅 2025-07-24 - an extensible key and secret validation tool for auditing active secrets against multiple SaaS vendors
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,354 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,087 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,389 | 🐛 15 | 🌐 Perl | 📅 2026-06-27 - A script to make Tor Network your default gateway.
...
* [sniffglue](https://github.com/kpcyrd/sniffglue) ⭐ 1,265 | 🐛 17 | 🌐 Rust | 📅 2026-04-19 - Secure multithreaded packet sniffer
...
* [Scapy](https://github.com/secdev/awesome-scapy) ⭐ 367 | 🐛 2 | 📅 2025-06-09 - A Python tool and library for low level packet creation and manipulation
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,141 | 🐛 479 | 🌐 C | 📅 2026-08-19 - A library and collection of command-line digital forensics tools
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,586 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - Automated decryption tool using artificial intelligence & natural language processing.
...
* [Awesome bug bounty resources by EdOverflow](https://github.com/EdOverflow/bugbounty-cheatsheet) ⭐ 6,541 | 🐛 12 | 📅 2023-09-14
...
* [Movies For Hackers](https://github.com/k4m4/movies-for-hackers) ⭐ 11,887 | 🐛 129 | 🌐 Shell | 📅 2024-08-01 - A curated list of movies every hacker & cyberpunk must watch.
...
* [silenttrinity](https://github.com/byt3bl33d3r/SILENTTRINITY) ⭐ 2,342 | 🐛 48 | 🌐 Boo | 📅 2023-12-06 - A post exploitation tool that uses iron python to get past powershell restrictions.
