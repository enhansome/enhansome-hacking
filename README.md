...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,312 | 🐛 29 | 🌐 Python | 📅 2026-09-12
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,994 | 🐛 606 | 🌐 Ruby | 📅 2026-09-11 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,835 | 🐛 197 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,494 | 🐛 581 | 🌐 C++ | 📅 2026-09-10 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,782 | 🐛 828 | 🌐 C | 📅 2026-09-12 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 9,012 | 🐛 358 | 🌐 C | 📅 2026-09-10
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,441 | 🐛 444 | 🌐 Java | 📅 2026-09-12 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,202 | 🐛 248 | 🌐 Java | 📅 2024-07-08

* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,249 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 - the best decompiler I have used. Is able to decompile apps written in Scala and Kotlin into Java code. JD-GUI and Luyten have failed to do it fully.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 26,058 | 🐛 172 | 🌐 C# | 📅 2026-09-12 - an open-source .NET assembly browser and decompiler
...
* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,996 | 🐛 446 | 🌐 JavaScript | 📅 2026-09-11
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 45,022 | 🐛 490 | 🌐 Python | 📅 2026-09-10 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,736 | 🐛 3,338 | 🌐 Java | 📅 2026-09-12 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,333 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,833 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,679 | 🐛 530 | 🌐 Shell | 📅 2026-08-31 - a DSL for creating parsers in a variety of programming languages. The Web IDE is particularly useful for reverse-engineering.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 26,002 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,421 | 🐛 6 | 🌐 Go | 📅 2026-09-11 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,400 | 🐛 62 | 🌐 Rust | 📅 2026-09-09 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,150 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,393 | 🐛 15 | 🌐 Perl | 📅 2026-09-12 - A script to make Tor Network your default gateway.
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,608 | 🐛 5 | 🌐 Rust | 📅 2026-09-09 - Automated decryption tool using artificial intelligence & natural language processing.
