...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,810 | 🐛 611 | 🌐 Ruby | 📅 2026-08-13 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,776 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,170 | 🐛 574 | 🌐 C++ | 📅 2026-08-15 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,573 | 🐛 819 | 🌐 C | 📅 2026-08-15 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,950 | 🐛 361 | 🌐 C | 📅 2026-08-13
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,077 | 🐛 443 | 🌐 Java | 📅 2026-08-05 - a decompiler for Android apps. Not related to JAD.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 25,861 | 🐛 192 | 🌐 C# | 📅 2026-08-15 - an open-source .NET assembly browser and decompiler
...
* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,986 | 🐛 433 | 🌐 JavaScript | 📅 2026-08-11
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,704 | 🐛 468 | 🌐 Python | 📅 2026-08-13 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,438 | 🐛 3,319 | 🌐 Java | 📅 2026-08-15 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,230 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
...
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,204 | 🐛 9 | 🌐 Go | 📅 2026-08-12 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,284 | 🐛 60 | 🌐 Rust | 📅 2026-07-29 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 14,983 | 🐛 236 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,378 | 🐛 15 | 🌐 Perl | 📅 2026-06-27 - A script to make Tor Network your default gateway.
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,127 | 🐛 479 | 🌐 C | 📅 2026-08-11 - A library and collection of command-line digital forensics tools
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,579 | 🐛 2 | 🌐 Rust | 📅 2026-08-10 - Automated decryption tool using artificial intelligence & natural language processing.
...
* [Movies For Hackers](https://github.com/k4m4/movies-for-hackers) ⭐ 11,858 | 🐛 129 | 🌐 Shell | 📅 2024-08-01 - A curated list of movies every hacker & cyberpunk must watch.
