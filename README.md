...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,229 | 🐛 30 | 🌐 Python | 📅 2026-08-27
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,925 | 🐛 600 | 🌐 Ruby | 📅 2026-08-31 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,805 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
* [Hackers tools](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv) - Tutorial on tools.

### Docker Images for Penetration Testing & Security

* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,713 | 🐛 858 | 🌐 Java | 📅 2026-08-27
* `docker pull vulnerables/web-owasp-nodegoat` - [OWASP NodeGoat](https://github.com/owasp/nodegoat#option-3---run-nodegoat-on-docker) ⭐ 2,061 | 🐛 107 | 🌐 HTML | 📅 2024-06-15
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,366 | 🐛 575 | 🌐 C++ | 📅 2026-08-30 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,692 | 🐛 823 | 🌐 C | 📅 2026-08-31 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,988 | 🐛 362 | 🌐 C | 📅 2026-08-31
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,281 | 🐛 442 | 🌐 Java | 📅 2026-08-31 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,184 | 🐛 248 | 🌐 Java | 📅 2024-07-08
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 25,989 | 🐛 181 | 🌐 C# | 📅 2026-08-30 - an open-source .NET assembly browser and decompiler
...
* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,992 | 🐛 439 | 🌐 JavaScript | 📅 2026-08-17
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,871 | 🐛 471 | 🌐 Python | 📅 2026-08-25 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,604 | 🐛 3,373 | 🌐 Java | 📅 2026-08-31 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,296 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,799 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,666 | 🐛 529 | 🌐 Shell | 📅 2026-08-31 - a DSL for creating parsers in a variety of programming languages. The Web IDE is particularly useful for reverse-engineering.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,964 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,346 | 🐛 2 | 🌐 Go | 📅 2026-08-31 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,345 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,082 | 🐛 239 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
...
* [Scapy](https://github.com/secdev/awesome-scapy) ⭐ 366 | 🐛 2 | 📅 2025-06-09 - A Python tool and library for low level packet creation and manipulation
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,138 | 🐛 479 | 🌐 C | 📅 2026-08-19 - A library and collection of command-line digital forensics tools
* [CyLR](https://github.com/orlikoski/CyLR) ⭐ 732 | 🐛 21 | 🌐 C# | 📅 2022-06-01 - NTFS forensic image collector
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,587 | 🐛 0 | 🌐 Rust | 📅 2026-08-31 - Automated decryption tool using artificial intelligence & natural language processing.
...
* [Awesome bug bounty resources by EdOverflow](https://github.com/EdOverflow/bugbounty-cheatsheet) ⭐ 6,539 | 🐛 12 | 📅 2023-09-14
