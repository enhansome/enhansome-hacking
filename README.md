...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,260 | 🐛 30 | 🌐 Python | 📅 2026-09-02
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,945 | 🐛 609 | 🌐 Ruby | 📅 2026-09-03 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,818 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
* [Hackers tools](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv) - Tutorial on tools.

### Docker Images for Penetration Testing & Security

* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,739 | 🐛 860 | 🌐 Java | 📅 2026-09-03
* `docker pull vulnerables/web-owasp-nodegoat` - [OWASP NodeGoat](https://github.com/owasp/nodegoat#option-3---run-nodegoat-on-docker) ⭐ 2,064 | 🐛 107 | 🌐 HTML | 📅 2024-06-15
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,404 | 🐛 576 | 🌐 C++ | 📅 2026-08-30 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,745 | 🐛 819 | 🌐 C | 📅 2026-09-05 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,999 | 🐛 357 | 🌐 C | 📅 2026-09-04
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,353 | 🐛 446 | 🌐 Java | 📅 2026-09-02 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,193 | 🐛 248 | 🌐 Java | 📅 2024-07-08
...
* [procyon](https://bitbucket.org/mstrobel/procyon/wiki/Java%20Decompiler)
  * [Luyten](https://github.com/deathmarine/Luyten) ⭐ 5,111 | 🐛 193 | 🌐 Java | 📅 2024-07-11 - one of the best, though a bit slow, hangs on some binaries and not very well maintained.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 26,018 | 🐛 170 | 🌐 C# | 📅 2026-09-05 - an open-source .NET assembly browser and decompiler
  * [dotPeek](https://www.jetbrains.com/decompiler/) - a free-of-charge .NET decompiler from JetBrains

* native code
  * [retdec](https://github.com/avast-tl/retdec) ⭐ 8,622 | 🐛 458 | 🌐 C++ | 📅 2026-05-26
...
* Python
  * [uncompyle6](https://github.com/rocky/python-uncompyle6) ⭐ 4,320 | 🐛 42 | 🌐 Python | 📅 2026-04-24 - decompiler for the over 20 releases and 20 years of CPython.

### Deobfuscators

* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,993 | 🐛 439 | 🌐 JavaScript | 📅 2026-09-02
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,922 | 🐛 480 | 🌐 Python | 📅 2026-09-01 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
* [USBPcap](https://github.com/desowin/usbpcap) ⭐ 1,131 | 🐛 65 | 🌐 C | 📅 2025-02-09 - USB capture for Windows.
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,670 | 🐛 3,362 | 🌐 Java | 📅 2026-09-05 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,313 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,814 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,672 | 🐛 529 | 🌐 Shell | 📅 2026-08-31 - a DSL for creating parsers in a variety of programming languages. The Web IDE is particularly useful for reverse-engineering.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,980 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,381 | 🐛 11 | 🌐 Go | 📅 2026-09-02 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [PhpSploit](https://github.com/nil0x42/phpsploit) ⭐ 2,491 | 🐛 27 | 🌐 Python | 📅 2024-05-06 - Full-featured C2 framework which silently persists on webserver via evil PHP oneliner
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,372 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,104 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,390 | 🐛 15 | 🌐 Perl | 📅 2026-06-27 - A script to make Tor Network your default gateway.
...
* [Habu](https://github.com/portantier/habu) ⭐ 985 | 🐛 3 | 🌐 Python | 📅 2025-12-30 - Python Network Hacking Toolkit
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,143 | 🐛 479 | 🌐 C | 📅 2026-08-19 - A library and collection of command-line digital forensics tools
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,590 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - Automated decryption tool using artificial intelligence & natural language processing.
...
* [Awesome bug bounty resources by EdOverflow](https://github.com/EdOverflow/bugbounty-cheatsheet) ⭐ 6,544 | 🐛 12 | 📅 2023-09-14
...
* [silenttrinity](https://github.com/byt3bl33d3r/SILENTTRINITY) ⭐ 2,341 | 🐛 48 | 🌐 Boo | 📅 2023-12-06 - A post exploitation tool that uses iron python to get past powershell restrictions.
