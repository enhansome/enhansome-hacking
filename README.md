...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,247 | 🐛 29 | 🌐 Python | 📅 2026-09-02
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,931 | 🐛 605 | 🌐 Ruby | 📅 2026-09-03 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,812 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
* [Hackers tools](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv) - Tutorial on tools.

### Docker Images for Penetration Testing & Security

* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,730 | 🐛 859 | 🌐 Java | 📅 2026-09-03
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,387 | 🐛 576 | 🌐 C++ | 📅 2026-08-30 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,724 | 🐛 822 | 🌐 C | 📅 2026-09-03 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,995 | 🐛 358 | 🌐 C | 📅 2026-09-03
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,329 | 🐛 443 | 🌐 Java | 📅 2026-09-02 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,189 | 🐛 248 | 🌐 Java | 📅 2024-07-08

* [Krakatau](https://github.com/Storyyeller/Krakatau) ⭐ 2,247 | 🐛 25 | 🌐 Rust | 📅 2026-04-07 - the best decompiler I have used. Is able to decompile apps written in Scala and Kotlin into Java code. JD-GUI and Luyten have failed to do it fully.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 26,003 | 🐛 171 | 🌐 C# | 📅 2026-09-03 - an open-source .NET assembly browser and decompiler
...
* [JS Beautifier](https://github.com/beautify-web/js-beautify) ⭐ 8,994 | 🐛 439 | 🌐 JavaScript | 📅 2026-09-02
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,901 | 🐛 480 | 🌐 Python | 📅 2026-09-01 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,643 | 🐛 3,360 | 🌐 Java | 📅 2026-09-03 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,306 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,810 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,671 | 🐛 529 | 🌐 Shell | 📅 2026-08-31 - a DSL for creating parsers in a variety of programming languages. The Web IDE is particularly useful for reverse-engineering.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,973 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,366 | 🐛 6 | 🌐 Go | 📅 2026-09-02 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,360 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,090 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,391 | 🐛 15 | 🌐 Perl | 📅 2026-06-27 - A script to make Tor Network your default gateway.
...
* [Habu](https://github.com/portantier/habu) ⭐ 984 | 🐛 3 | 🌐 Python | 📅 2025-12-30 - Python Network Hacking Toolkit
...
* [CyLR](https://github.com/orlikoski/CyLR) ⭐ 734 | 🐛 21 | 🌐 C# | 📅 2022-06-01 - NTFS forensic image collector
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,589 | 🐛 0 | 🌐 Rust | 📅 2026-09-01 - Automated decryption tool using artificial intelligence & natural language processing.
