...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,149 | 🐛 27 | 🌐 Python | 📅 2026-08-24
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,878 | 🐛 596 | 🌐 Ruby | 📅 2026-08-25 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,798 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
* [Hackers tools](https://www.youtube.com/playlist?list=PLyzOVJj3bHQuiujH1lpn8cA9dsyulbYRv) - Tutorial on tools.

### Docker Images for Penetration Testing & Security

* `docker pull owasp/zap2docker-stable` - [official OWASP ZAP](https://github.com/zaproxy/zaproxy) ⭐ 15,680 | 🐛 860 | 🌐 Java | 📅 2026-08-21
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,289 | 🐛 573 | 🌐 C++ | 📅 2026-08-23 - An open-source x64/x32 debugger for Windows
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,206 | 🐛 442 | 🌐 Java | 📅 2026-08-19 - a decompiler for Android apps. Not related to JAD.
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 25,942 | 🐛 180 | 🌐 C# | 📅 2026-08-25 - an open-source .NET assembly browser and decompiler
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,804 | 🐛 465 | 🌐 Python | 📅 2026-08-22 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,536 | 🐛 3,342 | 🌐 Java | 📅 2026-08-25 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,267 | 🐛 92 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,774 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
* [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct) ⭐ 4,663 | 🐛 528 | 🌐 Shell | 📅 2026-08-17 - a DSL for creating parsers in a variety of programming languages. The Web IDE is particularly useful for reverse-engineering.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,951 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,301 | 🐛 2 | 🌐 Go | 📅 2026-08-22 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,324 | 🐛 61 | 🌐 Rust | 📅 2026-07-29 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,040 | 🐛 237 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
* [Nipe](https://github.com/GouveaHeitor/nipe) ⭐ 2,386 | 🐛 15 | 🌐 Perl | 📅 2026-06-27 - A script to make Tor Network your default gateway.
...
* [Ciphey](https://github.com/ciphey/ciphey) ⭐ 21,581 | 🐛 2 | 🌐 Rust | 📅 2026-08-18 - Automated decryption tool using artificial intelligence & natural language processing.
