...
A curated list of awesome Hacking. Inspired by [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning/) ⭐ 74,255 | 🐛 30 | 🌐 Python | 📅 2026-09-02
...
* [Metasploit](https://github.com/rapid7/metasploit-framework) ⭐ 38,944 | 🐛 607 | 🌐 Ruby | 📅 2026-09-03 A computer security project that provides information about security vulnerabilities and aids in penetration testing and IDS signature development.
* [mimikatz](https://github.com/gentilkiwi/mimikatz) ⭐ 21,815 | 🐛 196 | 🌐 C | 📅 2026-04-17 - A little tool to play with Windows security
...
* `docker pull vulnerables/web-owasp-nodegoat` - [OWASP NodeGoat](https://github.com/owasp/nodegoat#option-3---run-nodegoat-on-docker) ⭐ 2,063 | 🐛 107 | 🌐 HTML | 📅 2024-06-15
...
* [x64dbg](https://github.com/x64dbg/x64dbg) ⭐ 49,399 | 🐛 576 | 🌐 C++ | 📅 2026-08-30 - An open-source x64/x32 debugger for Windows
* [radare2](https://github.com/radare/radare2) ⭐ 24,739 | 🐛 829 | 🌐 C | 📅 2026-09-03 - A portable reversing framework
* [Capstone](https://github.com/aquynh/capstone) ⭐ 8,999 | 🐛 358 | 🌐 C | 📅 2026-09-04
...
* [JADX](https://github.com/skylot/jadx) ⭐ 50,342 | 🐛 444 | 🌐 Java | 📅 2026-09-02 - a decompiler for Android apps. Not related to JAD.

* [JD-GUI](https://github.com/java-decompiler/jd-gui) ⭐ 15,191 | 🐛 248 | 🌐 Java | 📅 2024-07-08
...
* .net-based languages
  ...
  * [ILSpy](https://github.com/icsharpcode/ILSpy/) ⭐ 26,012 | 🐛 176 | 🌐 C# | 📅 2026-09-04 - an open-source .NET assembly browser and decompiler
...
* [mitmproxy](https://github.com/mitmproxy/mitmproxy) ⭐ 44,912 | 🐛 480 | 🌐 Python | 📅 2026-09-01 - An interactive, SSL-capable man-in-the-middle proxy for HTTP with a console interface
...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,662 | 🐛 3,357 | 🌐 Java | 📅 2026-09-04 - a DB editor.
* [Binwalk](https://github.com/ReFirmLabs/binwalk) ⭐ 14,310 | 🐛 93 | 🌐 Rust | 📅 2026-08-11 -  Detects signatures, unpacks archives, visualizes entropy.
* [Dependencies](https://github.com/lucasg/Dependencies) ⭐ 11,813 | 🐛 142 | 🌐 C# | 📅 2024-05-15 - a FOSS replacement to Dependency Walker.
...
* [masscan](https://github.com/robertdavidgraham/masscan) ⭐ 25,977 | 🐛 414 | 🌐 C | 📅 2026-04-23 - Internet scale portscanner.
* [SubFinder](https://github.com/subfinder/subfinder) ⭐ 14,376 | 🐛 7 | 🌐 Go | 📅 2026-09-02 - SubFinder is a subdomain discovery tool that discovers valid subdomains for any target using passive online sources.
...
* [RustScan](https://github.com/rustscan/rustscan) ⭐ 20,365 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - Extremely fast port scanner built with Rust, designed to scan all ports in a couple of seconds and utilizes nmap to perform port enumeration in a fraction of the time.
* [Amass](https://github.com/OWASP/Amass) ⭐ 15,099 | 🐛 242 | 🌐 Go | 📅 2026-07-19 - In-depth subdomain enumeration tool that performs scraping, recursive brute forcing, crawling of web archives, name altering and reverse DNS sweeping
...
* [sleuthkit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,142 | 🐛 479 | 🌐 C | 📅 2026-08-19 - A library and collection of command-line digital forensics tools
...
* [Awesome bug bounty resources by EdOverflow](https://github.com/EdOverflow/bugbounty-cheatsheet) ⭐ 6,542 | 🐛 12 | 📅 2023-09-14
